...
All comments raised during previous revisions have been addressed. The point-by-point response is attached.
...
=== Start of Point-by-point response ===

This resubmission has been extensively reworked with new results added. Major changes include:

- New title to reflect the fact the manuscript presents the method
- New results section "Networks with high/low coherence have distinct degree distributions"
    - New Figure 3 showing the degree distributions. Renaming of the following figures
    - New Additional File 9 showing the statistics of differential analysis of the degree distributions
- New results section "Coherence captures distinct network properties than modularity"
    - Updated Additional File 3 table showing modularity estimation
    - Updated Additional File 4 showing the correlation of modularity with other measures
- New results describing the untransformed slopes and the corresponding confidence intervals
    - Updated Additional File 3 table showing slopes and the corresponding confidence intervals in numerical format
    - Updated Additional File 4 showing the correlation of slopes and the sized of their confidence intervals with other measures
- All results have been described in the corresponding Results sections, Methods sections and legends got updated
...
Thank you for clearly summarizing our work. We adjusted the title to reflect the fact that the paper presents the method as "A Method for Estimating Coherence of Molecular Mechanisms In Major Human Disease and Traits."
...
We agree with the reviewer and intentionally chose our wording very carefully to highlight caveats in the current state of knowledge of both PPI databases and GWAS loci and emphasize the suggestive nature of our results. Additionally, we carefully selected references highlighting the whole spectrum of current knowledge and views, e.g., intentionally including reference 27 as an alternative to the current state of knowledge supported by several other peer-reviewed references. We did use cancer GWAS hits provided by GWAScatalog. Our goal was to present the methodology that can be used to compare molecular coherence of phenotypes while overcoming limitations of network analysis (differences in size, configuration). It was beyond the scope of our work to evaluate genes associated with rare variants, different effect sizes. The method itself can be applied to any GWAS results (see Discussion), including rare and somatic mutations, and reveal how coherent the associated gene networks are. We intentionally used the state-of-the-art list of GWAS results from GWAScatalog, and acknowledge the limitations of the current knowledge.
...
We agree that confidence intervals are important information that should be presented. We now report the untransformed slopes and the corresponding confidence intervals in numerical form (Additional file 3) and in terms of their correlations with network size (Additional file 4). It should be noted, however, that the untransformed slopes and their confidence intervals cannot be directly compared as they are expectedly affected by network size. We described those results in the "Network size and configuration hinders direct comparison of degree distributions" section. Normalizing confidence intervals using our strategy for normalizing slopes to size-matched random-high coherence range defy interpretability of confidence intervals in that their overlap would not be indicative of (the presence or the lack of) significant difference. Overall, we tried to keep our narrative maximally accessible to the reader while being quantitatively accurate. We report all numerical data in the main text or the additional files, e.g., the "overall correlation remained high" results can be easily seen on the cited Additional File 4 figure.
