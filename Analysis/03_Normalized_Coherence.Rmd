...
#Biogrid and STRING
ci = full_join(dis_slopes_biogrid_ci, dis_slopes_string_ci, by = c("Disease", "Category"))

#Merging in STRING Filtered
ci = full_join(ci, dis_slopes_string_filt_ci, by = c("Disease", "Category"))

write.csv(ci, 'Confidence_Intervals.csv', quote = FALSE)
```
