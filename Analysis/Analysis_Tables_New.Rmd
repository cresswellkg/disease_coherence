...
mtx0_cor <- mtx0[ mtx0 %>% dplyr::select(starts_with("Size")) %>% apply(., 1, min) > min_genes &
                  mtx0 %>% dplyr::select(starts_with("Size")) %>% apply(., 1, max) < max_genes, ]
# Remove size columns
mtx0_cor <- mtx0_cor %>% dplyr::select(contains("Coherence"), contains("Number"))
# Actual correlation
...
p_intelligence <- plot(mtx_traits_selected_dotplot(category = "Intelligence", mtx_traits = mtx0, databases = "String Filt"))
p_anthropometric <- plot(mtx_traits_selected_dotplot(category = "Anthropometric trait", mtx_traits = mtx0, databases = "String Filt"))
p_cardiovascular <- plot(mtx_traits_selected_dotplot(category = "Cardiovascular trait", mtx_traits = mtx0, databases = "String Filt"))

p_eye <- plot(mtx_traits_selected_dotplot(category = "Eye trait", mtx_traits = mtx0, databases = "String Filt"))
p_metabolic <- plot(mtx_traits_selected_dotplot(category = "Metabolic trait", mtx_traits = mtx0, databases = "String Filt"))

png(filename = "../manuscript/Figures/Fig3_summary_traits.png", height = 2500, width = 5000, res = 300)
lay1 <- rbind(c(1, 2, 3))
lay2 <- rbind(c(1, 2, 3))
...
```{r }
p_intelligence <- plot(mtx_traits_selected_dotplot(category = "Intelligence", mtx_traits = mtx0, databases = "Biogrid"))
p_anthropometric <- plot(mtx_traits_selected_dotplot(category = "Anthropometric trait", mtx_traits = mtx0, databases = "Biogrid"))
p_cardiovascular <- plot(mtx_traits_selected_dotplot(category = "Cardiovascular trait", mtx_traits = mtx0, databases = "Biogrid"))
p_eye <- plot(mtx_traits_selected_dotplot(category = "Eye trait", mtx_traits = mtx0, databases = "Biogrid"))
p_metabolic <- plot(mtx_traits_selected_dotplot(category = "Metabolic trait", mtx_traits = mtx0, databases = "Biogrid"))

png(filename = "../manuscript/Figures/FigS2_summary_traits_Biogrid.png", height = 2500, width = 6000, res = 300)
lay1 <- rbind(c(1, 2, 3))
lay2 <- rbind(c(1, 2, 3))
g1 <- arrangeGrob(grobs = list(p_anthropometric, p_cardiovascular, p_metabolic), layout_matrix = lay1)
g2 <- arrangeGrob(grobs = list(p_eye, p_intelligence), layout_matrix = lay2)
...
### FigS4_summary_traits_STRING.png

```{r }
p_intelligence <- plot(mtx_traits_selected_dotplot(category = "Intelligence", mtx_traits = mtx0, databases = "String"))
p_anthropometric <- plot(mtx_traits_selected_dotplot(category = "Anthropometric trait", mtx_traits = mtx0, databases = "String"))
p_cardiovascular <- plot(mtx_traits_selected_dotplot(category = "Cardiovascular trait", mtx_traits = mtx0, databases = "String"))
p_eye <- plot(mtx_traits_selected_dotplot(category = "Eye trait", mtx_traits = mtx0, databases = "String"))
p_metabolic <- plot(mtx_traits_selected_dotplot(category = "Metabolic trait", mtx_traits = mtx0, databases = "String"))

png(filename = "../manuscript/Figures/FigS4_summary_traits_STRING.png", height = 2500, width = 6000, res = 300)
lay1 <- rbind(c(1, 2, 3))
lay2 <- rbind(c(1, 2, 3))
g1 <- arrangeGrob(grobs = list(p_anthropometric, p_cardiovascular, p_metabolic), layout_matrix = lay1)
g2 <- arrangeGrob(grobs = list(p_eye, p_intelligence), layout_matrix = lay2)
...
p_anthropometric <- plot(mtx_traits_selected_dotplot(category = "Cancer", mtx_traits = mtx0, databases = "String Filt"))
p_cardiovascular <- plot(mtx_traits_selected_dotplot(category = "Cardiovascular disease", mtx_traits = mtx0, databases = "String Filt"))
p_eye <- plot(mtx_traits_selected_dotplot(category = "Eye disease", mtx_traits = mtx0, databases = "String Filt"))
p_metabolic <- plot(mtx_traits_selected_dotplot(category = "Metabolic disease", mtx_traits = mtx0, databases = "String Filt"))
p_neurologic <- plot(mtx_traits_selected_dotplot(category = "Neurologic", mtx_traits = mtx0, databases = "String Filt"))
p_psychiatric <- plot(mtx_traits_selected_dotplot(category = "Psychiatric", mtx_traits = mtx0, databases = "String Filt")) 

png(filename = "../manuscript/Figures/Fig4_summary_diseases.png", height = 2500, width = 5000, res = 300)
...
p_anthropometric <- plot(mtx_traits_selected_dotplot(category = "Cancer", mtx_traits = mtx0, databases = "Biogrid"))
p_cardiovascular <- plot(mtx_traits_selected_dotplot(category = "Cardiovascular disease", mtx_traits = mtx0, databases = "Biogrid"))
p_eye <- plot(mtx_traits_selected_dotplot(category = "Eye disease", mtx_traits = mtx0, databases = "Biogrid"))
p_metabolic <- plot(mtx_traits_selected_dotplot(category = "Metabolic disease", mtx_traits = mtx0, databases = "Biogrid"))
p_neurologic <- plot(mtx_traits_selected_dotplot(category = "Neurologic", mtx_traits = mtx0, databases = "Biogrid"))
p_psychiatric <- plot(mtx_traits_selected_dotplot(category = "Psychiatric", mtx_traits = mtx0, databases = "Biogrid"))

png(filename = "../manuscript/Figures/FigS4_summary_diseases_Biogrid.png", height = 3000, width = 8000, res = 300)
lay1 <- rbind(c(1, 2, 3, 4))
lay2 <- rbind(c(1, 2, 3, 4))
g1 <- arrangeGrob(grobs = list(p_intelligence, p_anthropometric, p_neurologic, p_psychiatric), layout_matrix = lay1)
g2 <- arrangeGrob(grobs = list(p_cardiovascular, p_metabolic, p_eye), layout_matrix = lay2)
...
p_anthropometric <- plot(mtx_traits_selected_dotplot(category = "Cancer", mtx_traits = mtx0, databases = "String"))
p_cardiovascular <- plot(mtx_traits_selected_dotplot(category = "Cardiovascular disease", mtx_traits = mtx0, databases = "String"))
p_eye <- plot(mtx_traits_selected_dotplot(category = "Eye disease", mtx_traits = mtx0, databases = "String"))
p_metabolic <- plot(mtx_traits_selected_dotplot(category = "Metabolic disease", mtx_traits = mtx0, databases = "String"))
p_neurologic <- plot(mtx_traits_selected_dotplot(category = "Neurologic", mtx_traits = mtx0, databases = "String"))
p_psychiatric <- plot(mtx_traits_selected_dotplot(category = "Psychiatric", mtx_traits = mtx0, databases = "String"))

png(filename = "../manuscript/Figures/FigS5_summary_diseases_STRING.png", height = 3000, width = 8000, res = 300)
lay1 <- rbind(c(1, 2, 3, 4))
lay2 <- rbind(c(1, 2, 3, 4))
g1 <- arrangeGrob(grobs = list(p_intelligence, p_anthropometric, p_neurologic, p_psychiatric), layout_matrix = lay1)
g2 <- arrangeGrob(grobs = list(p_cardiovascular, p_metabolic, p_eye), layout_matrix = lay2)
