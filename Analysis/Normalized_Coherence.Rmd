...
source("./functions/get_msig_slopes.R") [??? This does not exist!]
...
get_msig_slopes = function(sub_cats, database) { [??? Calls to this function use "subcat", not "sub_cat" argument - correct]
  require(msigdbr)
  msig = msigdbr()
...
[??? After hacking around, normalized coherence objects still contain data for ONE disease, not many. What is going on?]
